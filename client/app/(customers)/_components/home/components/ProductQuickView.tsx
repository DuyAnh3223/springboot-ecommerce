        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3.5 rounded-2xl bg-rose-50/60 border border-rose-100">
              <span className="text-xs text-slate-500 font-medium block mb-0.5">GiÃ¡ sáº£n pháº©m:</span>
            ...
            <div className="flex items-center gap-2 text-xs font-semibold">
              {isOutOfStock ? (
                <span className="inline-flex items-center gap-1 text-rose-400">
                  <XCircle className="w-4 h-4" /> Táº¡m háº¿t hÃ ng
                </span>
              ) : (
                <span className="inline-flex items-center gap-1 text-emerald-400">
                  <CheckCircle2 className="w-4 h-4" /> CÃ²n hÃ ng (Sáºµn sÃ ng giao)
                </span>
              )}
            </div>
            ...
            <div className="space-y-2 text-xs text-slate-300 border-t border-b border-slate-800 py-3">
              <div className="flex items-center gap-2">
                ...
                <span>Báº£o hÃ nh 1 Ä‘á»•i 1 chÃ­nh hÃ£ng táº¡i ABTechZone</span>
              </div>
              <div className="flex items-center gap-2">
                <Truck className="w-4 h-4 text-indigo-400" />
                <span>Miá»…n phÃ­ giao hÃ ng toÃ n quá»‘c Ä‘Æ¡n tá»« 2.000.000Ä‘</span>
              </div>
            </div>

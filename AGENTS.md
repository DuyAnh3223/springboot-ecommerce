...
This project is indexed by GitNexus as **springboot-ecommerce** (8314 symbols, 40799 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

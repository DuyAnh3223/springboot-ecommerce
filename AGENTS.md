...
This project is indexed by GitNexus as **springboot-ecommerce** (7520 symbols, 31118 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **springboot-ecommerce** (6417 symbols, 13566 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

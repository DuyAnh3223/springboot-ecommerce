...
This project is indexed by GitNexus as **springboot-ecommerce** (7849 symbols, 36989 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
